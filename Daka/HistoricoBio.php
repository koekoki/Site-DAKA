    ...
    font-weight: bolder;">  <?php  if(isset($_SESSION['Email'])){
        ...
        <div class = "box">
            ...
            <?php
                    ...
                    $q3= "SELECT COUNT(IdQuestao) FROM historico WHERE Email LIKE '$Email' and idArea = 3";
                    $ansresults3 = mysqli_query($connect,$q3);
                    $certa= "SELECT COUNT(Acertou) FROM historico WHERE Email LIKE '$Email' and Acertou = 1 and idArea = 3";
            		...
            		$q= "SELECT *  FROM historico where Email Like '$Email' and idArea = 3";
                    $ansresults = mysqli_query($connect,$q);
                    
                    while($rows = mysqli_fetch_array($ansresults)){
                    $number = $rows['IdQuestao'];
                    $q2= "SELECT * FROM questao where IdQuestao = $number ";
                    $ansresults2 = mysqli_query($connect,$q2);
                    $q4= "SELECT * FROM historico where IdQuestao = $number and Email LIKE '$Email' and idArea = 3";
