...
<header style="height: 100px;">
        ...
        <h2 class="title title-second">FISICA</h2>
			...
			<div class="container">
				...
				<form method="POST" action="gabaritoExatas.php" style="font-family: 'Open Sans', sans-serif;
    			font-weight: bold;
   				 margin-left: 10%;
   				 margin-right: 10%;
					text-align: justify;">
				<?php 
					...
					$l = 1;
					$ansid = $i;
					$sql1 = "SELECT * FROM questao where IdQuestao = $i and idMateria = 5";
				...
				?>
					<div class="linha"></div>
					<div class="enunciado">
                    <p><p class="Numeroquestao"> Questão <?php echo $i-45 .". "?></p><?php echo $row1['Enunciado'];?> </p>
					</div>
					...
					$ansid = $ansid + $l;
                     ...
                     <h2 class="title title-second">MATEMATICA</h2>
                     	<?php 
                            ...
                            $sql1 = "SELECT * FROM questao where IdQuestao = $i and idMateria = 4";
                            $result1 = mysqli_query($connect, $sql1);
                                if(mysqli_num_rows($result1)>0){
                                    while($row1 = mysqli_fetch_assoc($result1)){
                            ?>
                            <div class="linha"></div>
                            <div class="enunciado">
                            <p><p class="Numeroquestao"> Questão <?php echo $i-135 .". "?></p><?php echo $row1['Enunciado'];?> </p>
                            </div>
                     	...
                     	<?php 
                            ...
                            $sql1 = "SELECT * FROM questao where IdQuestao = $i and idMateria = 7";
                            $result1 = mysqli_query($connect, $sql1);
                                if(mysqli_num_rows($result1)>0){
                                    while($row1 = mysqli_fetch_assoc($result1)){
                            ?>
                            <div class="linha"></div>
                            <div class="enunciado">
                            <p><p class="Numeroquestao"> Questão <?php echo $i-90 .". "?></p><?php echo $row1['Enunciado'];?> </p>
                            </div>
